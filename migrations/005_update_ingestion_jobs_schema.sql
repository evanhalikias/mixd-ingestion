...
-- 5. Add safety constraint to prevent duplicate jobs
CREATE UNIQUE INDEX IF NOT EXISTS idx_ingestion_jobs_unique_daily 
ON ingestion_jobs (worker_type, (job_payload->>'source_id'), (job_payload->>'mode'), DATE_TRUNC('day', created_at))
